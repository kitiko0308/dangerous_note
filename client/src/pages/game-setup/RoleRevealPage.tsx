      ...
      <div className="title-screen">
        ...
        <main className="role-reveal__main">
          ...
          <div className="role-reveal__header">
            <h2 className="title-logo role-reveal__title">
              役職の確認
            </h2>
          ...
          <div className="role-reveal__layout">
            ...
            <div className="role-reveal__art">
              {isShowing && (
                <p className="role-reveal-tabs-hint" style={{ transform: 'translateX(75px)' }}>
                  ▼ 他の役職を確認する
                </p>
              )}
              {isShowing && (
              ...
              <img src={isKira ? kiraImg : isL ? lImg : siminnImg} alt={isKira ? "キラ" : isL ? "L" : "市民"} className={isKira ? "role-kira-art-side role-reveal__art-image" : isL ? "role-l-art-side role-reveal__art-image" : "role-villager-art-side role-reveal__art-image"} />
            </div>
            ...
            <div className="role-reveal__panel">
              ...
              <div className="role-reveal__card" style={{ boxShadow: `0 0 18px ${accentColor}14` }}>
                ...
                <h1 className="role-reveal__role-name" style={{ color: accentColor }}>{roleNames[displayRole]}</h1>
                {isKira && (
                  <p className="role-reveal__role-copy" style={{ color: '#fca5a5' }}>名前を書かれた人間は死ぬ。</p>
                )}
                {isL && (
                  <p className="role-reveal__role-copy" style={{ color: '#93c5fd' }}>真実は、調査すればするほど浮かび上がる。</p>
                )}
                {isVillager && (
                  <p className="role-reveal__role-copy" style={{ color: '#86efac' }}>あなたの一票が、村を救う。</p>
                )}
              </div>
              ...
              {/* ボタン */}
              <button className="dn-button role-reveal-action-button role-reveal__action" onClick={handleNext}>
          ...
          <div className="role-reveal__dots">
            {players.map((_, i) => (
              <div key={i} className="role-reveal__progress-dot" style={{ backgroundColor: i === currentPlayerIndex ? 'var(--kira-red)' : 'var(--border-color)' }} />
            ))}
          </div>
        </main>
      </div>
